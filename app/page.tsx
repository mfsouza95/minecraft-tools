      ...
      <div>
        ...
        className="relative z-10 py-4">
          <div className="border-4 border-white text-white rounded-sm p-4 flex justify-center w-fit mx-auto drop-shadow-lg backdrop-blur-xs bg-white/10">
            <h1 className="font-(family-name:--font-minecraft) text-4xl">CREEPER TOOLS</h1>
          </div>
          <div className="border-4 border-white text-white rounded-lg w-fit  mx-auto justify-center p-4 m-8 grid grid-cols-2 md:grid-cols-5 grid-rows-6 drop-shadow-2xl backdrop-blur-xs bg-white/20 font-(family-name:--font-minecraft)">
